...
export default class TokenMintTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): TokenMintTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): HashgraphProto.proto.ITokenMintTransactionBody;
}
export namespace HashgraphProto {
    namespace proto {
        ...
        type ITokenMintTransactionBody = import("@hashgraph/proto").proto.ITokenMintTransactionBody;
